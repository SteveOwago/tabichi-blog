                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="tabichi.html">Tabich's Story</a></li>
									<li class="dropdown"><a href="blog.html">News</a></li>
    ...
    <footer class="main-footer">
		<div class="auto-container">
            ...
            <div class="footer-bottom clearfix">
                <div class="pull-left">
                    <div class="copyright"><a href="templateshub.net">Peter Tabichi</a></div>
                </div>
                <div class="pull-right">
                    <a href="templateshub.net">Peter Tabichi</a>
                </div>
            </div>
...
<!--tabichi/testimonials.html  30 Nov 2019 03:49:30 GMT -->
</html>