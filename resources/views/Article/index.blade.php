...
@guest
    <div class="join-panel">
        <h4 style="margin-bottom:30px;">Sign in Now!!</h4>
        <a style="font-size:20px" class="login-btn" href="{{ route('login') }}">LOGIN</a>
        <p style="margin-top:40px;">Sign in to create your interestin Articles! </p>
        <span>LETS BE THE DIFFERENCE WE WANNA SEE</span>
    </div>
@endguest
@endsection -->
