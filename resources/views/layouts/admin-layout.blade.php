    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <div class="sidebar-brand-text mx-3">Tabichi Blog</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item"
                                    href="{{ route('profile', ['user' => Auth::user()->id, 'slug' => Auth::user()->slug]) }}">Your
                                    profile</a>
                                <a class="dropdown-item"
                                    href="{{ route('profile.edit', ['user' => Auth::user()->id]) }}">Edit your
                                    profile</a>
                                <a class="dropdown-item" href="{{ route('article.create') }}">Create article</a>
                                <div class="dropdown-divider"></div>

                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item nav-dropdown" href="{{ route('logout') }}" onclick="event.preventDefault();
                                      document.getElementById('logout-form').submit();">
                                    {{ __('Logout') }}
                                </a>
                ...
                <div>
                    ...
                    @endif
                    @if (Session::has('UserCreatedMessage'))
                        <div class="alert alert-success alert-dismissible fade show session" role="alert">
                            {{ Session::get('UserCreatedMessage') }}
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    @endif
                    @if (Session::has('NewsCreatedMessage'))
                        <div class="alert alert-success alert-dismissible fade show session" role="alert">
                            {{ Session::get('NewsCreatedMessage') }}
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
