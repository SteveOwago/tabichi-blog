...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto order-1">
                <li class="nav-item">
                    <a href="/" class="nav-link navbar-link link">Back Home</a>
                </li>
                <li class="nav-item">
                    <a href="" class="nav-link navbar-link link">Settings</a>
                </li>
                <li class="nav-item">
                    <a href="" class="nav-link navbar-link link">Help</a>
                </li>
            </ul>
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <!-- <div class="col-md-4">@yield('RightSide')</div> -->
        </div>
        </div>
    </div>
