...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-one">
        ...
        <div class="header-top">
            <div class="auto-container clearfix">
                <div class="top-left clearfix">
                    <div class="text"><span class="icon flaticon-call-answer"></span> Need help? Call Us Now : <a href="tel:1800-456-7890" class="number">1234567890</a></div>
            ...
            <div class="inner-container">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo-outer">
                        <div class="logo"><a href="{{route('tabichi.index')}}"><img src="{{asset('tabichi/images/tabichi-logo.png')}}"   title=""></a></div>
                    </div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
									...
									<li class="current dropdown"><a href="{{route('tabichi.about')}}">About us</a>
                                        <ul>
                                            <li><a href="{{route('tabichi.about')}}">Our Introduction</a></li>
											<li><a href="{{route('tabichi.about')}}">Our Team</a></li>
											<li><a href="{{route('tabichi.testimonials')}}">Testimonials</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="{{route('tabichi.story')}}">Tabichi's Story</a></li>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('tabichi/images/tabichi-logo.png')}}"    title=""></a></div>
	...
	<section class="call-to-action-section" style="background-image: url('{{asset('tabichi/images/background/1.jpg')}}');">
		<div class="auto-container">
			<h2>Tabichi Foundation</h2>
			<div class="text">Get In Touch <br> We have you in our Hearts.</div>
			<a href="{{route('tabichi.contact')}} " class="theme-btn btn-style-two"><span class="txt">contact us</span></a>
		</div>
	</section>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
                                    	<a href="{{ route('tabichi.index') }}"><img src="{{asset('tabichi/images/tabichi-logo.png')}}"/></a>
                                    </div>
                            ...
                            <div class="footer-column col-lg-5 col-md-6 col-sm-12">
                                <div class="footer-widget contact-widget">
									...
									<div class="widget-content">
										...
										<ul>
											<li>Nakuru</li>
											<li>Email :<a href="mailto:info@petertabichi.org"> info@petertabichi.org</a></li>
										</ul>
									</div>
								</div>
							</div>
